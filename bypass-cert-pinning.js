setTimeout(function() {
  Java.perform(function () {
    console.log();
    console.log('[#] Android Bypass for constious Certificate Pinning methods [#]');
    ...
    try {
      ...
      //const netty_FingerprintTrustManagerFactory = Java.use('org.jboss.netty.handler.ssl.util.FingerprintTrustManagerFactory');
